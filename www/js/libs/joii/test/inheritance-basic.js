test('Class - Inheriting (basic)', function (assert) {
    ...
    var first = Class({
        a: 0, __construct: function () {
            this.a = 1;
        }
    });
    var second = Class({'extends': first}, {
        b: 1, __construct: function () {
            this.b = this.a + 1;
            this.a = 10;
        }
    });
    var third = Class({'extends': second}, {
        c: 1, __construct: function () {
            this.c = this.b + 1;
        }
    });
    ...
    var B1 = Class({
        ...
        my_object: [{}],
        set: function (a, b) {
            this.my_object[0][a] = b;
        },
        get: function (a) {
            return this.my_object[0][a];
        },
        add: function (a) {
            this.my_array.push(a);
        }
    });
    ...
    C2 = Class({'extends': C1, 'final': ['foobar']}, {
        foobar: function () {
        }
    });
    try {
